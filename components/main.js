    ...
    <View style={styles.container}> 
      ...
      <View style={styles.profile}>
        <View style={styles.picView}>
          <Image style={styles.picture} source={require('../assets/pic.png')}/>
        </View>
        <View style={styles.nameTitle}>
          <Text style={styles.nameText}> Pepper_Egglant </Text>
          <Text style={styles.nameTitleText}> [Admin] </Text>
          ...
          <ScrollView contentContainerStyle={styles.scrollViewContainer} horizontal={true}>
            <View style={styles.gameApi}>
              <View style={styles.gameBox}>
                ...
                <Image source={require('../assets/owGold.png')} style={styles.rank} />
              </View>
              <View style={styles.gameBox}>
                <Image source={require('../assets/gamebox.png')} />
        ...
        <ScrollView contentContainerStyle={styles.scrollViewContainer}>
            <View style={styles.timelineView}>
              <View style={styles.postBox}>
                ...
                <Image source={require('../assets/pic.png')} style={styles.postPic} />
                <Text style={styles.postBoxText}>Playing League right now. Dm me if you want to party!</Text>
              ...
              <View style={styles.postBox}>
                <Image source={require('../assets/postBox.png')} />
                <Image source={require('../assets/pic.png')} style={styles.postPic} />
                <Text style={styles.postBoxText}>I am so hungry...</Text>
              ...
              <View style={styles.postBox}>
                <Image source={require('../assets/postBox.png')} />
                <Image source={require('../assets/pic.png')} style={styles.postPic} />
                <Text style={styles.postBoxText}>Sooooo bored</Text>
